...
export default function WhatsAppQuickBuy() {
  ...
  return (
    <a 
      ...
      className="whatsapp-quick-buy"
      aria-label="Quick Buy on WhatsApp"
    >
      <style jsx>{`
        .whatsapp-quick-buy {
          display: none;
        ...
        .whatsapp-quick-buy:hover .wa-label {
          opacity: 1;
        ...
        @media (max-width: 768px) {
          .whatsapp-quick-buy { display: flex; }
        }
      `}</style>
      
      <span className="wa-label">Quick Buy</span>
